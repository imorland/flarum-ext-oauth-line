...
/***/ "./src/admin/components/LineOAuthPage.js":
/*!***********************************************!*\
  !*** ./src/admin/components/LineOAuthPage.js ***!
  \***********************************************/
...
/* harmony export */   "default": () => (/* binding */ LineOAuthPage)
/* harmony export */ });
...
var LineOAuthPage = /*#__PURE__*/function (_ExtensionPage) {
  (0,_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(LineOAuthPage, _ExtensionPage);
  function LineOAuthPage() {
    return _ExtensionPage.apply(this, arguments) || this;
  }
  var _proto = LineOAuthPage.prototype;
  ...
  _proto.content = function content() {
    return [m("div", {
      ...
      className: "LineOAuthSettingsPage"
    }, m("br", null), m((flarum_common_components_LinkButton__WEBPACK_IMPORTED_MODULE_3___default()), {
      className: "Button",
      href: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().route('extension', {
        id: 'fof-oauth'
      })
    }, flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('fof-oauth.admin.configure_button_label'))))];
  };
  return LineOAuthPage;
...
/* harmony import */ var _components_LineOAuthPage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/LineOAuthPage */ "./src/admin/components/LineOAuthPage.js");


flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('ianm-oauth-line', function () {
  flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().extensionData["for"]('ianm-oauth-line').registerPage(_components_LineOAuthPage__WEBPACK_IMPORTED_MODULE_1__["default"]);
});
